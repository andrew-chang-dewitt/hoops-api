...
1. ✅ When User creates an Account, an Account is saved & they are given the new Account
    1. ☑️ When a User requests a list of all of their Accounts, they are given a paginated list of Accounts
...
2. ✅ When a User adds a Transaction to an Account, a Transaction is saved & they are given the new Transaction
    1. ☑️ When a User requests their Transactions for a given Account, they are given a paginated list of Transactions
    4. ☑️ When a User requests their Transactions for all Accounts, they are given a paginated list of Transactions
